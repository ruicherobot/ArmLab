...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnUser18 = QtGui.QPushButton(self.OutputFrame)
        self.btnUser18.setAutoRepeatDelay(300)
        self.btnUser18.setObjectName(_fromUtf8("btnUser18"))
        self.Group2.addWidget(self.btnUser18)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnUser15.setText(_translate("MainWindow", "USER 15", None))
        self.btnUser16.setText(_translate("MainWindow", "USER 16", None))
        self.btnUser17.setText(_translate("MainWindow", "USER 17", None))
        self.btnUser18.setText(_translate("MainWindow", "USER 18", None))
